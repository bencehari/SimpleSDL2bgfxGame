#ifndef KE_DDS_HEADER_H
#define KE_DDS_HEADER_H
...
#define DDS_HEADER_FALGS_PITCH 			(DDSD_PITCH)
...
#define DDS_CUBEMAP_NEGATIVEX		(DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_NEGATIVEX)
#define DDS_CUBEMAP_POSITIVEY		(DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_POSITIVEY)
#define DDS_CUBEMAP_NEGATIVEY		(DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_NEGATIVEY)
#define DDS_CUBEMAP_POSITIVEZ		(DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_POSITIVEZ)
#define DDS_CUBEMAP_NEGATIVEZ		(DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_NEGATIVEZ)
#define DDS_CUBEMAP_ALLFACES		(DDS_CUBEMAP_POSITIVEX | DDS_CUBEMAP_NEGATIVEX | DDS_CUBEMAP_POSITIVEY | \
									DDS_CUBEMAP_NEGATIVEY | DDS_CUBEMAP_POSITIVEZ | DDSCAPS2_CUBEMAP_NEGATIVEZ)
#define DDS_FLAGS_VOLUME			(DDSCAPS2_VOLUME)
...
enum DXGI_FORMAT {
	...
	// TODO: warning: ISO C restricts enumerator values to range of 'int' before C2X [-Wpedantic]
	// any idea?
